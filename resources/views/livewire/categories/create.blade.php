            ...
            <x-slot name="content">
                <div class="mt-4">
                    ...
                    <x-jet-input type="name" class="mt-1 block w-3/4 {{$errors->has('name') ? 'border-red-500' : ''}}"
                        x-ref="name" wire:model.defer="name" wire:keydown.enter="save" />

                    <x-jet-input-error for="name" class="mt-2" />
                </div>

                <div class="mt-4 w-full">
                    <x-jet-label for="name" value="{{ __('Rodzaj') }}" />
                ...
                <div class="mt-4">
                    ...
                    <x-jet-input type="file" class="mt-1 block w-3/4 {{$errors->has('icon') ? 'border-red-500' : ''}}"
                        wire:model.defer="icon" wire:keydown.enter="save" />
